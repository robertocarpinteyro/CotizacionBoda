...
export const translations = {
  es: {
    ...
    pricing: {
      ...
      paymentNote: 'Precios + IVA en transferencia o tarjeta. En efectivo sin IVA.',
      cta: 'Apartar Ahora',
      packages: [
        {
          name: 'Esencial',
          ...
          features: [
            '1 día de cobertura',
            'Getting ready, ceremonia y recepción (hasta 8 hrs)',
            '1 Videógrafo profesional',
            '1 Operador de drone certificado',
            '3 Reels de hasta 40 seg para redes sociales',
        ...
        },
        {
          ...
          price: '$119,000',
          currency: 'MXN',
          description: 'La máxima producción cinematográfica con extras exclusivos para tu boda.',
          featured: false,
          features: [
            'Todo lo del paquete Cinematográfico',
            'Video extendido Full Feature (15-20 min)',
            'Teaser editado el mismo día del evento',
            'Sesión pre-boda / Save the Date en video',
            '30 Fotografías profesionales incluidas',
            'Invitaciones digitales con formulario RSVP',
            'Behind the scenes de tu boda',
          ],
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Si el pago es por transferencia bancaria o tarjeta de crédito, el precio del paquete elegido es + IVA. Si el pago es en efectivo, el precio es sin IVA. Aplica para los 3 paquetes.',
        },
      ],
    },
  ...
  en: {
    ...
    pricing: {
      ...
      paymentNote: 'Prices + Tax (IVA) for bank transfer or credit card. Cash payments are tax-free.',
      cta: 'Book Now',
      packages: [
        {
          name: 'Essential',
          ...
          features: [
            '1-day coverage',
            'Getting ready, ceremony & reception (up to 8 hrs)',
            '1 Professional videographer',
            '1 Certified drone operator',
            '3 Reels up to 40 sec for social media',
        ...
        },
        {
          ...
          price: '$119,000',
          currency: 'MXN',
          description: 'The ultimate cinematic production with exclusive extras for your wedding.',
          featured: false,
          features: [
            'Everything in the Cinematic package',
            'Extended Full Feature video (15-20 min)',
            'Same-day edited teaser',
            'Pre-wedding / Save the Date video session',
            '30 Professional photos included',
            'Digital invitations with RSVP form',
            'Behind the scenes of your wedding',
          ],
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'If payment is by bank transfer or credit card, the price of your chosen package is + IVA (tax). If payment is in cash, the price is tax-free. This applies to all 3 packages.',
        },
      ],
    },
